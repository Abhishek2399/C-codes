...
namespace CollectionsGenerics
{
    class MyDelegates
    {
        ...
        public void MySort<T>(List<T> data, SortDelegate<T> sd) // as the list can be of any specific type we hvae to make it generic and the delegate we are using is already generic 
        {
