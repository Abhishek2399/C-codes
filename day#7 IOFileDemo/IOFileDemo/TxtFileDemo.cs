...
namespace IOFileDemo
{
    class TxtFileDemo
    {
        static void Main()
        {
            ...
            string path = @"D:\capgemini\training\technical\C#\day#7 IOFileDemo\IOFileDemo\";
            string fileName = "Abhishek.txt";
            string fileName2 = "Sparsh.txt";
           /*
            ...
            FileStream fileStream = new FileStream(path + fileName, FileMode.Create, FileAccess.Write); // (<name of file>, <mode of the file we want to create>, <access level of the file write>)
